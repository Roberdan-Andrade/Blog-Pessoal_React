...
function Cadastro() {
   ...
   //Hook useNavigate que vai redirecionar rotas
   const navigate = useNavigate();

   //Estado que vai guardar dados do usuario
   ...
   //Estado que vai indicar quando a animação de loading vai acontecer
   ...
   async function cadastrarNovoUsuario(e: FormEvent<HTMLFormElement>) {
      ...
      if (confirmaSenha === usuario.senha && usuario.senha.length >= 8) {
         ...
         ToastAlerta("Dados inconsistentes! Verifique a informaçoes do cadastro!", "Info")
